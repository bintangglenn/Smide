        ...
        <div class="col-md-5">
            <form class="form-horizontal" action="app.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label class="control-label col-sm-4" for="msg"><p style="float:left;">File</p>:</label>
                    <div class="col-sm-8">
                      <input type="file" name="decryptedFile" id="decryptedFile" class="form-control" required>
                    </div>
                </div>
                <div class="form-group">
